...
function buildPolicyBlock(responsePolicy = {}) {
	return [
		...
		'- Si la conversacion ya esta empezada, segui el hilo sin saludar de nuevo.',
		'- Si el mensaje es solo un saludo, contesta breve y pregunta que esta buscando.',
